  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      for(int i = 0; i < listDaftarSewaDummy.value.length; i++){
        if(listDaftarSewaDummy.value[i] == 1 && i != 0){
                                      ...
                                      builder: (context) {
                                        ...
                                        switch(listDaftarSewaDummy.value[i]){
                                                ...
                                                Positioned.fill(
                                                  ...
                                                  child: Material(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: (){
                                                        for(int i = 0; i < listDaftarSewaDummy.value.length; i++){
                                                          if (listDaftarSewaDummy.value[i] == 2){
                                                            listDaftarSewaDummy.value[i] = 1;
                                                          }
                                                        }
                                          ...
                                          case 2: {
                                            ...
                                            if((i > 0 && listDaftarSewaDummy.value[i - 1] != 2) || i == 0){
                                              isBegin = true;
                                            }
                                            if((i < length - 1 && listDaftarSewaDummy.value[i + 1] != 2) || i == length - 1){
                                              isEnd = true;
                                            }
                                                      ...
                                                      Positioned.fill(
                                                        child: Material(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: (){
                                                              for(int j = 0; j < listDaftarSewaDummy.value.length; j++){
                                                                if(listDaftarSewaDummy.value[j] == 2){
                    ...
                    builder: (context, value, child) {
                      ...
                      for(int i = 0; i < listDaftarSewaDummy.value.length; i++){
                        if(listDaftarSewaDummy.value[i] == 2){
                          choosenCount += 1;
                          lastChoosen = i;
                          if(i < listDaftarSewaDummy.value.length - 1 && listDaftarSewaDummy.value[i + 1] == 1){
                            if(hourLimit == null || (hourLimit != null && choosenCount < hourLimit!)){
